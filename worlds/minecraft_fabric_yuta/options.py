...
class LightningTrapWeight(BaseTrapWeight):
    """
    Likelihood of a receiving a trap that strikes the player with lightning
    """
    display_name = "Lightning Trap Weight"

class ItemDropTrapWeight(BaseTrapWeight):
    """
    Likelihood of a receiving a trap that forces the player to drop items
    """
    display_name = "Item Drop Trap Weight"

class NighttimeTrapWeight(BaseTrapWeight):
    """
    Likelihood of a receiving a trap that sets the time to night
    """
    display_name = "Nighttime Trap Weight"

class BoxTrapWeight(BaseTrapWeight):
    """
    Likelihood of a receiving a trap that traps the player in a temporary box... or drops one on you
    """
    display_name = "Box Trap Weight"

class ShuffleTrapWeight(BaseTrapWeight):
    """
    Likelihood of a receiving a trap that shuffles the player's inventory
    """
...
class FMCOptions(PerGameCommonOptions):
    ...
    lightning_trap_weight: LightningTrapWeight
    item_drop_trap_weight: ItemDropTrapWeight
    nighttime_trap_weight: NighttimeTrapWeight
    box_trap_weight: BoxTrapWeight
